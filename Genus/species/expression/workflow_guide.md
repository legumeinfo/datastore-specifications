...
```
Rscript --vanilla  /erdos/elavelle/co_metrics.R rnaseq_out/star_salmon/salmon.merged.gene_tpm.tsv
```
...
/falafel/elavelle/make_bigwigs.sh <samples.tsv.gz> <chromosome_sizes_file>
