# Objective: Prepare assembly and annotation collection for Phytozome Cercis canadensis
...
# Variables for this job
  ...
  PZGSP=Ccanadensis # For Phytozome, use the directory name that contains the versioned directory.
  ...
  GNM=gnm3
  ANN=ann1
  GENOME=Ccanadensis_705_V3.0 # The filename prefix common among all genome files in the source
  ANNOTATION=Ccanadensis_705_V3.1 # The filename prefix ommon among all annotation files in the source
...
# Compress all files except DataReleasePolicy.html and readme.txt
